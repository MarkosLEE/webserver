...
const std::map<string,int> ParseHttp::methodName={
    ...
    {"TRACE",GET},{"OPTIONS",OPTIONS},{"CONNECT",CONNECT}
};
...
const std::map<string,int> ParseHttp::header={
    {"Host",Host},{"User-Agent",User_Agent},{"Connection",Connection},{"Accept",Accept},
    {"Accept-Language",Accept_Language},{"Accept-Encoding",Accept_Encoding},{"Upgrade-Insecure-Requests",Upgrade_Insecure_Requests}
};
